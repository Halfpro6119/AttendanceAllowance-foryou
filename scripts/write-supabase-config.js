...
`;
  ...
  process.stdout.write('Wrote supabase/config.js from SUPABASE_URL / SUPABASE_ANON_KEY\n');
} else if (isCi) {
  ...
  process.stdout.write('Leaving existing supabase/config.js unchanged (set SUPABASE_URL + SUPABASE_ANON_KEY to overwrite)\n');
}
